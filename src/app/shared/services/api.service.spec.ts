...
describe('ApiService', () => {
  ...
  describe('getTags', () => {
    it('should return a list of tags', () => {
      ...
      apiService.getTags().pipe(take(1)).subscribe((response) => {
        tags = response;
      });
      const req = httpTestingController.expectOne('http://localhost:3004/rest/tags');
  ...
  describe('createTag', () => {
    it('should create a tag', () => {
      ...
      apiService.createTag('foo').pipe(take(1)).subscribe((response) => {
        tag = response;
      });
      const req = httpTestingController.expectOne('http://localhost:3004/rest/tags');
      req.flush({ id: '1', name: 'foo' });
    ...
    it('throws an error if request fails', () => {
      ...
      apiService.createTag('foo').pipe(take(1)).subscribe({
        next: () => {
